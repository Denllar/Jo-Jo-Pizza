...
const Cart = () => {
  ...
  const totalCount = cart.reduce((acc: number, cur: any) => cur.count + acc, 0);
      ...
      <div className="cart">
        <div className="cart__top">
          <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            Корзина</h2>
          <div onClick={() => dispatch(setClearCart())} className="cart__top__clear">
        ...
        <div className="cart__bottom">
          ...
          <div className="cart__bottom-buttons">
            <Link to={"/Jo-Jo-Pizza/"} className="button button--outline button--add go-back-btn">
